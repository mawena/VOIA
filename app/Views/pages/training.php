<div class="container">
    <div class="container-fluid">
        ...
        <br>
        <?php if (!empty($training) && is_array($training)) : ?>
            <?php foreach ($training as $training_item) : ?>
                <div class="card mb-3 bg-blue">
                    <h3 class="card-header bg-orange"><?= esc($training_item['name']) ?></h3>
                    ...
                    <div class="modal-footer bg-blue">
                        <a class="btn nav-btn-orange" id="btn-orange" href="/formations/<?= esc($training_item['slug'], 'url') ?>">Voir plus</a>
                    </div>
                </div>
                <br>
                <br>
