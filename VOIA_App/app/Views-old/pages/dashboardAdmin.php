        ...
        <div id="left-side">
            ...
            <div id="commerciaux-list">
                ...
                if (isset($commercialUserArray) && !empty($commercialUserArray)) {
                    foreach ($commercialUserArray as $key => $commercialUser) {
                ?>
                        <button class="commercial" onClick="javascript:test(<?php echo $key;?>)"><?php echo $commercialUser["username"] ?></button>
                        <!-- <div id="<?php echo $key; ?>" onclick="test"><?php echo $commercialUser["username"] ?></div> -->
                <?php
                    }
                }
                ?>
            ...
            <div id="waiting">
                ...
                <div>
                    ...
                    if (isset($userWaitingArray) && !empty($userWaitingArray)) {
                        foreach ($userWaitingArray as $user) {
                    ?>
